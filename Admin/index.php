...
<head>
  ...
  <title>E-POSTES | <?=$data['nama_lengkap']; ?></title>
  <!-- plugins:css -->
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="../vendor/images/logo-mts2.png" />
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="masterData" style="background-color:#212121;">
              ...
              <li class="nav-item">
                    ...
                    <i class="fa fa-angle-double-right" style="font-size:20px;color:#fff;"></i> &nbsp;<span class="menu-title">Data Bagian</span></a>
               </li>

               <li class="nav-item">
                 	 <a class="nav-link" href="?page=semester" style="color:#fff;">
                    <i class="fa fa-angle-double-right" style="font-size:20px;color:#fff;"></i> &nbsp;<span class="menu-title">Master Data Tahap</span></a>
               </li>

               <li class="nav-item">
                 	 <a class="nav-link" href="?page=mapel" style="color:#fff;">
                    <i class="fa fa-angle-double-right" style="font-size:20px;color:#fff;"></i> &nbsp;<span class="menu-title">Master Data Materi</span></a>
               </li>

               <li class="nav-item">
                 	 <a class="nav-link" href="?page=jenisujian" style="color:#fff;">
                    <i class="fa fa-angle-double-right" style="font-size:20px;color:#fff;"></i> &nbsp;<span class="menu-title">Master Jenis Penilaian</span></a>
               </li>
              ...
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item">
                    ...
                    <i class="fa fa-user-circle" style="font-size:20px;color:#fff;"></i> &nbsp;&nbsp;
                       <span class="menu-title">SUPERVISOR</span></a>
             	</li>
                <li class="nav-item">
                 	 <a class="nav-link" href="?page=siswa" style="color:#fff;">
                    <i class="fa fa-user-circle-o" style="font-size:20px;color:#fff;"></i> &nbsp;&nbsp;<span class="menu-title">KARYAWAN</span></a>
             	</li>
             	</li>
              </ul>
            </div>
