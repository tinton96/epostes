            ...
            <div class="card-body">
              ...
              <form class="forms-sample" action="?page=proses" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label for="mapel">Materi Kelas Bagian</label>
                ...
                <a href="javascript:history.back()" class="btn btn-danger">Batal</a>
                  ...
                  <p>
                  File yang bisa di Upload hanya file dengan ekstensi .jpg, .png, .doc, .docx, .xls, .xlsx, .ppt, .pptx, .pdf, .rar, .exe, .zip dan besar file (file size) maksimal hanya <b>2 MB</b>.
                  </p>
