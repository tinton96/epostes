<div class="content-wrapper">
  <h4>
  Data Pengawas Kelas <small class="text-muted">/ Tambah</small>
  </h4>
  <hr>
  <div class="row">
        ...
        <div class="col-12 col-xs-12">
          <div class="card">
            ...
            <div class="form-group">
              <label for="mapel">Data Materi</label>
           ...
           <!--  <a data-toggle="modal" data-target="#mapelAdd" class="input-group-text bg-transparent"><i class="fa fa-plus text-white"></i></a> -->
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                  <label for="semester">Tahap</label>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h4 class="modal-title">Add Data Pengawas Kelas</h4>
                  </div>
                   <form method="post" action="">
                  <div class="modal-body"><label>Data Pengawas Kelas</label>
