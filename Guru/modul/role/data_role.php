  ...
  <hr>
          ...
          if (empty($role['id_guru'])) {
            ?>
              <div class="row purchace-popup">
                <div class="col-md-12">
                  ...
                  <p>Saat ini Anda belum memilih kelas Pengawas, Silahkan Tambahkan Data Pengawas Untuk Memulai .</p>
                  <a href="?page=mapel&act=add" class="btn ml-auto purchase-button"> <i class="fa fa-plus"></i> Tambah Data Pengawas</a>
            ...
            ?>
              <div class="row purchace-popup">
                <div class="col-md-12">
                  <span class="d-flex alifn-items-center">
                 <a href="?page=mapel&act=add" class="btn btn-dark"> <i class="fa fa-plus"></i> Add Data Pengawas Kelas</a>
                  </span>
                </div>
              </div>
          ...
          <div class="row">
           <div class="col-md-12">
               ...
               <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Data Pengawas Kelas</h4>
