...
<head>
  ...
  <title>E-POSTES  | <?=$data['nama_guru']; ?></title>
  <!-- plugins:css -->
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <!--   <li class="nav-item">
             ...
             <li class="nav-item">
            <a class="nav-link" href="?page=mapel"><img class="menu-icon" src="../vendor/images/menu_icons/02.png" alt="menu icon"> <span class="menu-title">Data Pengawas</span></a>
          </li>
         ...
         <li class="nav-item">
            ...
            <div class="collapse" id="materi">
              ...
              <i class="fa fa-file-text"></i> &nbsp;&nbsp;SEMUA MATERI</a>
               ...
               <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#tugas" aria-expanded="false" aria-controls="general-pages"> <img class="menu-icon" src="../vendor/images/menu_icons/04.png" alt="menu icon"> <span class="menu-title">TUGAS KARYAWAN</span><i class="menu-arrow"></i>
            </a>
