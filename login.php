    ...
    <header id="header-wrap">
      ...
      <div id="roof" class="hidden-xs">
          <div class="container">
              <!-- Wellcome Starts -->
              <div class="pull-left">
                <i class="fa fa-home" aria-hidden="true"></i> Sekolahku
              </div>
              <!-- Wellcome End -->

              <!-- Quick Contacts Starts -->
              <div class="quick-contacts pull-right">
                  <span><i class="fa fa-phone"></i> (879789)</span>
                  <span><i class="fa fa-envelope"></i><a href="#">education@aaa.com</a></span>
          ...
          <div class="row">
            <div class="col-md-6  col-sm-6">
              <p class="copyright-text">
                © <a rel="nofollow" href=""><b>e-Guru</b> </a> 2020 - MTs.Misbahunnur
              </p>
            </div>
            <div class="col-md-6  col-sm-6">                
