...
<html lang="en">
<head>
	<title>E-POSTES </title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
<!--===============================================================================================-->	
	<link rel="shortcut icon" type="image/png" href="vendor/images/logo-mts2.png"/>
<!--===============================================================================================-->
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('vendor/login/images/');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
			 <center><img src="vendor/images/Aliyah.png" alt="" height="100" width="100"></center><br>
				<form method="post" action="" class="login100-form validate-form">
				<center><img src="vendor/images/4.JPG" alt="" height="250" width="250"></center>
